...
public class VehiculoPropietarioBO {
    ...
    public Integer insertar(Integer id_vehiculo, Integer id_propietario){
        VehiculoPropietarioDTO vehiculoPropietarioDTO = new VehiculoPropietarioDTO();
        vehiculoPropietarioDTO.setId_vehiculo(id_vehiculo);
        vehiculoPropietarioDTO.setId_propietario(id_propietario);
    ...
    public Integer modificar(Integer id, Integer id_vehiculo, Integer id_propietario){
        VehiculoPropietarioDTO vehiculoPropietarioDTO = new VehiculoPropietarioDTO();
